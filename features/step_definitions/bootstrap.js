...
module.exports = function bootstrap() {
    ...
    this.Then(/^I see "([1-9][0-9]*)" elements in "([^"]+)"$/, function (num, selector) {
        return this.seeNumberOfElements(selector, num);
    });
    ...
    this.Given(/^I scroll to "([^"]+)" with offset "([1-9][0-9]*)" "([1-9][0-9]*)"$/, function (locator, offsetX, offsetY) {
        return this.scrollTo(locator, offsetX, offsetY);
    });
    ...
    this.Given(/^I move cursor to "([^"]+)" with offset "([1-9][0-9]*)" "([1-9][0-9]*)"$/, function (locator, offsetX, offsetY) {
        return this.moveCursorTo(locator, offsetX, offsetY);
    });
    ...
    this.Given(/^I resize window to "([1-9][0-9]*)" "([1-9][0-9]*)"$/, function (width, height) {
    ...
    this.Given(/^I wait "([1-9][0-9]*)" seconds$/, function (sec) {
        return this.wait(sec);
    });

    this.Given(/^I wait "([1-9][0-9]*)" seconds for element "([^"]+)"$/, function (sec, locator) {
        return this.waitForElement(locator, sec);
    });

    this.Given(/^I wait "([1-9][0-9]*)" seconds for text "([^"]+)"$/, function (sec, text) {
        return this.waitForText(text, sec);
    });

    this.Given(/^I wait "([1-9][0-9]*)" seconds for element "([^"]+)" to show$/, function (sec, locator) {
        return this.waitForVisible(locator, sec);
    });

    this.Given(/^I wait "([1-9][0-9]*)" seconds for element "([^"]+)" to hide/, function (sec, locator) {
        return this.waitToHide(locator, sec);
    });
